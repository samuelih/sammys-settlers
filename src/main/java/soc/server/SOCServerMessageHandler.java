 ...
 * This file Copyright (C) 2016-2021,2023-2026 Jeremy D Monin <jeremy@nand.net>
...
public class SOCServerMessageHandler
{
    ...
    private void handleGAMEOPTIONGETINFOS(Connection c, SOCGameOptionGetInfos mes)
    {
        ...
        for (SOCGameOption opt : opts.values())
        {
            ...
            {
                if ((opt.minVersion > cliVers) && opt.hasFlag(SOCGameOption.FLAG_OPPORTUNISTIC))
                    opt = opt.forClientVersion(cliVers);
                    ...
                    && opt.hasFlag(SOCGameOption.FLAG_OPPORTUNISTIC_CLIENT_JOIN_ONLY))
                {
                    ...
                    localDesc = localDesc + ' ' + cannotCreate;
                }
            }
