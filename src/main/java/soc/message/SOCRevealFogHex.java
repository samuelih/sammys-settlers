...
public class SOCRevealFogHex extends SOCMessageTemplate3i
{
     ...
     * Converts {@code hexCoord} to decimal from hexadecimal format.
     ...
     * {@code hexCoord} is hexadecimal like those in {@link SOCBoardLayout2}.
     *
    ...
    public String toString()
    {
        return "SOCRevealFogHex:game=" + game
            + "|hexCoord=" + Integer.toHexString(p1) + "|hexType=" + p2 + "|diceNum=" + p3;
    }
